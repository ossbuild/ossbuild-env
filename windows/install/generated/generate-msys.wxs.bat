...
%HEAT% dir "%MSYSDIR%" -sw5150 -nologo -ag -sreg -scom -svb6 -sfrag -template fragment -dr OSSBuildBuildEnvInstallDir -var var.MSYS_DIR -t msys.xslt -cg OSSBuildBuildEnvMSys -out "%DIR%\msys.wxs"
